...
//Adding stations
addStations(['M1', 'RC'], ['100.6', '99.5']);
addStations(['Pukas FM', 'PowerHitRadio'], ['95,96', '100,00']);
addStations(['RelaxFM', 'Opus'], ['102,45', '99,4']);

btnBack.addEventListener('click', function () {
  if (stationIndex == 0) {
    currentStation.innerHTML =
      stationData.stationName[stationData.stationName.length - 1];
